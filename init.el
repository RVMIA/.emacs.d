...
(custom-set-variables
 ...
 '(package-selected-packages
   '(edwina underwater-theme vterm xresources-theme haskell-mode popup-kill-ring dmenu diminish spaceline org-bullets company dashboard rainbow-delimiters sudo-edit hungry-delete switch-window rainbow-mode avy smex ido-vertical-mode beacon liso-theme which-key use-package))
